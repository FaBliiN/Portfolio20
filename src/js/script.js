...
let vision = [];
vision.push(new projecto ("8F project @Ford ITP","src/images/vision1.png","<p>2017</p><br> I was the leading vision machine systems engineer for the 8F Transmition program for all the Hanwha Lines. I created more that <span class='blue_text'>40 aplications</span> including:<br><br> <ul> <li>Color Matching</li> <li>Parts Presence/Absence</li>  <li>Parts Correct Installation</li>  <li>2D/Data Matrix Read</li></ul><br> with PC Based cameras using <span class='blue_text'>Ether inspect</span> and <span class='blue_text'>Cognex VisionPro</span> Utility. I was responsable for the application analysis, the vision systems integration and capability studies to create reliable machine vision solutions"));
...
vision.push(new projecto ("Production Support Engineer @GM TTO","src/images/vision4.png","<p>2020</p><br> At GM Toledo, OH. I was supporting production with vision systems. I had to keep line wunning keeping the capability of the cameras and it was quite challenging because we have new and old vision systems working together. I was supporting 6F, 8F and machinning Area."));

let cobots = [];
cobots.push(new projecto ("Oil Leak & Connectors latched @Ford Dragon","src/images/cobots.png","<p>2018</p><br> So far my favorite project. I was working for <span class='blue_text'>Micromatic</span>. They develop a system to inspect Oil leak after motor cold test and check if all the connectors were latched. For that we were using <span class='blue_text'>4 Universal Robots UR3</span> to move cameras around the motors to take pictures of it. For the Oil leak we were using <span class='blue_text'>UV</span> light that made the oil looks green in the images. The challenging one was the connectors inspectios were we struggle finding the right position for the camera to avoid the loose wires."));
